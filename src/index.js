...
function connectPayroll() {
  ...
  window.gtag("event", "link_opened", {
    value: "Link Opened",
    event_label: "Link Opened",
  });
}
        ...
        <ThemeProvider theme={theme}>
          <>
            ...
            <Wrapper>
              ...
              <Paragraph>
                You understand that if you provide inaccurate credentials we may be unable to process your loan application. If we are not able to verify necessary items through the Argyle service, you may be required to undergo manual verification. By providing Prosper or Argyle with your login credentials or other information for a Workforce Platform, you represent and warrant that such information is accurate, complete, and owned by you, and that you are authorized to provide such information for the purpose of collecting and using End User Data as described in this agreement.  You further represent and warrant that you are authorized to permit third parties, including Prosper and Argyle, to electronically access the Workforce Platform accounts and electronically retrieve End User Data therefrom. You represent and warrant that by using the Argyle service and entering into and complying with this agreement, you are not violating any agreements you may have with any Workforce Platform or any third party.
              </Paragraph>
              <Paragraph>
                You shall defend, indemnify, and hold Prosper, Argyle, and our and their respective owners, members, officers, directors, employees, agents, successors, licensees, licensors, and assigns harmless from and against any damages, liabilities, losses, expenses, claims, actions, and/or demands, including, without limitation, reasonable legal and accounting fees, arising from or in connection with: (i) your breach of this agreement including, without limitation, any of the representations and warranties set forth herein above; (ii) your violation of any third-party rights, including without limitation any copyright, trademark, property, publicity, or privacy right; or (iii) your gross negligence, willful misconduct, or fraud.
              </Paragraph>
            </Wrapper>
          </>
        </ThemeProvider>
